...
function AdminWikiIndicesRoute() {
    return (
        <RequireRole roles={['admin', 'super-admin']}>
            <AdminShell section="wiki-indices">
                <WikiIndicesView />
            </AdminShell>
        </RequireRole>
    );
...
function AdminAutoWikiSettingsRoute() {
    return (
        <RequireRole roles={['admin', 'super-admin']}>
            <AdminShell section="autowiki-settings">
                <AutoWikiSettingsView />
            </AdminShell>
        </RequireRole>
    );
}

 ...
 *
 *   kb_nodes — one row per canonical concept. `node_uid` is the slug (unique
 *              globally for simplicity; the node_uid naming already includes
 *              project conventions when generated by CanonicalIndexerJob).
 *              `project_code` scopes all queries per tenant.
 *
 *   kb_edges — typed relation between two nodes (ON DELETE CASCADE on both
 *              endpoints). `provenance` records how the edge was created

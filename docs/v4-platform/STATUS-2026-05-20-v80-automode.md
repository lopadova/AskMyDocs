...
- updated_at_utc: 2026-05-21T00:23:05Z
- goal: 100% roadmap completion
- base_branch: feature/v8.0
- open_pr_count: 1
- agent_state: ready_to_merge_pr_213
- last_action: Reconciled PR #213 on 2026-05-21; head 9ba67301bebcaa5c0b8099768e2b60406fa3c6c1 is CLEAN with no must-fix findings and all checks SUCCESS
- next_action: post closure audit comment on PR #213 and merge with --merge --delete-branch
...
- prs:
  ...
  - #213: https://github.com/lopadova/AskMyDocs/pull/213 (head: feature/v8.0-W7.1-mcp-tenant-tokens, sha: 9ba67301bebcaa5c0b8099768e2b60406fa3c6c1, status: open, checks: green, review: no_must_fix)

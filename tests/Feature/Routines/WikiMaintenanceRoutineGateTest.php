...
final class WikiMaintenanceRoutineGateTest extends TestCase
{
    ...
    public function test_flag_on_target_registered_and_an_active_routine_exists_disables_the_cron(): void
    {
        config(['kb.wiki_routine.enabled' => true]);
        app(TargetRegistry::class)->register(app(WikiMaintenanceRoutineTarget::class));
    ...
    public function test_flag_on_but_only_a_paused_routine_exists_keeps_the_cron(): void
    {
        config(['kb.wiki_routine.enabled' => true]);
        app(TargetRegistry::class)->register(app(WikiMaintenanceRoutineTarget::class));

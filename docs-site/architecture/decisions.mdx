...
- **[ADR 0023](https://github.com/lopadova/AskMyDocs/blob/main/docs/adr/0023-v830-widget-identity-and-current-session.md) — Widget identity credentials and current-session restore.**

...
For the full editorial record, see the curated decisions narrative
and the ADR index.

## Where to go deeper

<CardGroup cols={2}>
  <Card title="Retrieval pipeline" icon="layer-group" href="/core-concepts">
    Hybrid search, reranker fusion weights, and the boost/penalty knobs.
  </Card>
  <Card title="Canonical graph" icon="share-nodes" href="/multi-tenant-isolation">
    kb_nodes / kb_edges, project-scoped composite FKs, and graph rebuild.
  </Card>
  <Card title="Auto-Wiki engine" icon="wand-magic-sparkles" href="/anti-hallucination-firewall">
    The self-compiling phases and the firewall that contains them.
  </Card>
  <Card title="Database schema" icon="database" href="/core-concepts">

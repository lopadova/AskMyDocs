...
once you have reviewed the report. `eval:nightly` additionally honours its own
`EVAL_NIGHTLY_ENABLED` feature gate on top of the schedule slot.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Self-hosting" icon="server" href="/self-hosting">
    Worker + cron setup and command usage examples.
  </Card>
</CardGroup>

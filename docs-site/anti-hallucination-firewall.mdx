...
AskMyDocs deliberately lets an LLM *write* knowledge — the [Auto-Wiki](/auto-wiki)
...
php artisan kb:wiki-review domain-concepts/caching.md          # cross-model audit
php artisan kb:wiki-promote domain-concepts/caching.md --project=eng  # auto → human
```

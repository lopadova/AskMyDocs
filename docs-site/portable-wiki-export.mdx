...
description: "A CLI that compiles a project's knowledge into an ACL- and PII-scoped folder anyone can read offline, with a consistency-checked manifest and no server dependency."
icon: "folder-tree"
---

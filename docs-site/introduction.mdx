...
<CardGroup cols={2}>
  <Card title="Human-gated canonical promotion" icon="user-check" href="/canonical-and-promotion">
  ...
  <Card title="Self-compiling Auto-Wiki" icon="wand-magic-sparkles" href="/auto-wiki">
  ...
  <Card title="Field-level PII redaction" icon="shield-halved" href="/pii-and-compliance">
  ...
  <Card title="Eval-harness CI gate" icon="flask" href="/sister-packages">

...
flowchart LR
    ...
    subgraph Ingestion
      DOC[Markdown / PDF / DOCX / scans-OCR / connectors] --> ING[DocumentIngestor]
...
<CardGroup cols={2}>
  ...
  <Card title="Document Intelligence" icon="file-magnifying-glass" href="/documents-and-ocr">
    OCR of scans and images, faithful conversion-artifact versioning, a
    propose-only Digitization Review loop, and an already-compiled portable
    wiki export — closing a 2026 competitor's exact gap without its ungated
    agent-write shortcut.
  </Card>
</CardGroup>

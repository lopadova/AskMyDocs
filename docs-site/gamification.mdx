---
title: "Gamification (opt-in)"
description: "A tasteful, default-off contributor-motivation layer: badges awarded when all-time engagement crosses a configurable threshold — a view over engagement metrics, computing nothing new."
icon: "award"
---

...
| [0023](https://github.com/lopadova/AskMyDocs/blob/main/docs/adr/0023-v830-widget-identity-and-current-session.md) | v8.30 Audited widget identity credentials + explicit current-session restore |

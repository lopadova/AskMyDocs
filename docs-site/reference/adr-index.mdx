...
| [0023](https://github.com/lopadova/AskMyDocs/blob/main/docs/adr/0023-v830-system-admin-boundary.md) | v8.30 System administrator boundary above tenant super-admin |
| [0024](https://github.com/lopadova/AskMyDocs/blob/main/docs/adr/0024-v830-membership-required-operational-tenants.md) | v8.30 Membership required on operational tenants |
| [0025](https://github.com/lopadova/AskMyDocs/blob/main/docs/adr/0025-v830-registration-invite-onboarding.md) | v8.30 Registration intent + company onboarding |
| [0026](https://github.com/lopadova/AskMyDocs/blob/main/docs/adr/0026-v829-email-dataset-safety-boundary.md) | v8.29 Bounded generation + CLI-only email dataset safety boundary |
| [0027](https://github.com/lopadova/AskMyDocs/blob/main/docs/adr/0027-v830-widget-identity-and-current-session.md) | v8.30 Audited widget identity credentials + explicit current-session restore |
| [0028](https://github.com/lopadova/AskMyDocs/blob/main/docs/adr/0028-source-acl-mirroring-and-ingest-provenance.md) | v8.32 → v8.34 Source ACL mirroring + ingest-time provenance |
| [0029](https://github.com/lopadova/AskMyDocs/blob/main/docs/adr/0029-v836-ocr-converter-drivers-and-ocr-provenance.md) | v8.36 OCR converter, pluggable drivers, and OCR provenance |
| [0030](https://github.com/lopadova/AskMyDocs/blob/main/docs/adr/0030-v836-conversion-artifacts-on-the-time-machine.md) | v8.36 Conversion artifacts on the Time Machine |

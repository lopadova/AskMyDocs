...
To reverse a tokenised document, use the **Log Viewer detokenize endpoint**
(`POST /api/admin/logs/chat/{id}/detokenize`) or the PII Redactor Admin SPA
cross-mounted at `/app/admin/pii-redactor`. Both surfaces are RBAC-gated and
fully audited.

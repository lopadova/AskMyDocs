...
| `imap` | **Credential** (basic / delegated XOAUTH2 / **M365 app-only** client-credentials) | the first credential-based connector — see [Credential-based connectors](/connectors-credential) |

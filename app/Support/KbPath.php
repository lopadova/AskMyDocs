...
class KbPath
{
     ...
     * `{source}.ocr/…` (OCR runs + figures, v8.36 / ADR 0029) and any
     * `.artifacts/` segment — the conversion-artifact root of ADR 0030,
     * wherever it sits under the KB prefix (`prefix/.artifacts/…` is one).

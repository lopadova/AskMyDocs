...
- **Not yet shipped**: the *advanced* review UI (original ↔ Markdown side-by-side, confidence heat-map) and the CER/WER quality metrics — these land in later W3 sub-branches before the v8.37 GA tag.

...
- **Not yet shipped**: the review UI (original ↔ Markdown side-by-side, confidence heat-map — propose/approve/reject above are HTTP + MCP only today, with no dedicated frontend), and the CER/WER quality metrics — these land in later W3 sub-branches before the v8.37 GA tag.
...
**v8.36.0-rc1 — Document intelligence W1+W2: OCR ingestion and conversion artifacts on the Time Machine (W1+W2 merged 2026-09-16; the `v8.36.0-rc1`/`v8.36.0` tags themselves are pending — see the "Tags" note in [PR #492](https://github.com/lopadova/AskMyDocs/pull/492)).**

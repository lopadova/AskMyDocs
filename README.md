...
**v8.38.0 — Portable Wiki Export + candidate-only import: `.mcp.json`, frontmatter round-trip, `kb:import-wiki` (W4 merged to `feature/v8.38` 2026-09-25, pending its own GA merge to `main` — see the "Tags" note in [STATUS](docs/v4-platform/STATUS-2026-09-25-v838-w4-closure.md)).**

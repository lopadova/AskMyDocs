...
| **`padosoft/laravel-patent-box-tracker` v0.1 dogfood** | W4 ships the standalone `padosoft/laravel-patent-box-tracker` package on Packagist plus the `tools/patent-box/2026.yml` template config — Lorenzo's FY2026 Italian Patent Box dossier (Padosoft ditta individuale) is generated by `php artisan patent-box:cross-repo` against AskMyDocs `feature/v4.0` and the sister Padosoft repositories |
...
- Real-world dogfood: AskMyDocs ships `tools/patent-box/2026.yml` —
  ...
  individuale, regime `documentazione_idonea`) is generated by
  `php artisan patent-box:cross-repo tools/patent-box/2026.yml`

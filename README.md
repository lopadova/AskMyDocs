...
**v8.22.0 — Invite-by-code & referral suite (in progress, PR #363).**
...
virality analytics. Each invite carries a per-tenant **grant** — a Spatie role

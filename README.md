...
| **v4.6** | ✅ shipped 2026-05-12 | Connector package extraction — 7 inline connectors lifted to `padosoft/askmydocs-connector-*` packages + shared `-base` package + `padosoft/askmydocs-connector-template` for community contributors |
